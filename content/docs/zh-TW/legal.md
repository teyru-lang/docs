...
## 4. 編輯器工具（[`teyru-lang/editors`](https://github.com/teyru-lang/editors)）
...
| `tree-sitter-teyru/grammar.js`、`queries/`、`test/` | 本專案原創 | GPL-2.0-only，見 `tree-sitter-teyru/LICENSE` |
| `vscode/`（TextMate 語法、語言設定、片段） | 本專案原創 | 見 `LICENSE` |
