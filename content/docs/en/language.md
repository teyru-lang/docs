...
| `com.google.gson` | `lib/10`, `lib/19` | Gson's tree API, plus the object binding generated by the compiler (see [docs/json.md](/en/docs/json)) |
| framework | `lib/17`, `lib/18` | A Spring-shaped container and web layer (see [docs/framework.md](/en/docs/framework)) |
